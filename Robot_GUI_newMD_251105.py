...
class GUI(QWidget):
    ...
    NODE_ID_RH  = 0x6   # RH_SAG
    NODE_ID_LH  = 0x7   # LH_SAG
    NODE_ID_RK  = 0x8
    NODE_ID_LK  = 0x9
    NODE_ID_RA  = 0xC   # RA_LAT
    NODE_ID_LA  = 0xD   # LA_LAT
    ...
    SDO_FAIL = -1
    ##SDO ID MSG
    SDO_ID_MSG_SET_STATE        = 1
    SDO_ID_MSG_SET_ROUTINE      = 3
    SDO_ID_MSG_PDO_LIST         = 5   # 예전 0x04 → 지금 5
    SDO_ID_MSG_GUI_COMM_ONOFF   = 7   # 예전 0x06 → 지금 7
    SDO_ID_MSG_GUI_COMM_COMMAND = 8   # 예전 0x07 → 지금 8
    ##SDO ID LOWLEVEL
    SDO_ID_LOWLEVEL_GET_STATE   = 0
    SDO_ID_LOWLEVEL_SET_STATE   = 1
    SDO_ID_LOWLEVEL_GET_ROUTINE = 2
    SDO_ID_LOWLEVEL_SET_ROUTINE = 3
    ##SDO ID MIDLEVEL
    SDO_ID_MIDLEVEL_GET_STATE   = 0
    SDO_ID_MIDLEVEL_SET_STATE   = 1
    SDO_ID_MIDLEVEL_GET_ROUTINE = 2
    SDO_ID_MIDLEVEL_SET_ROUTINE = 3

    SDO_ID_MIDLEVEL_POSITION_PERIODIC_SIG_INFO = 14

    SDO_ID_MIDLEVEL_POSITION_CTRL_P_GAIN       = 25
    SDO_ID_MIDLEVEL_POSITION_CTRL_D_GAIN       = 26
    SDO_ID_MIDLEVEL_MID_CTRL_SATURATION        = 27

    SDO_ID_MIDLEVEL_SYSTEM_ID_SBS_INFO         = 45

    # ---- Flexi-SEA block----
    SDO_ID_MIDLEVEL_POSITION_Tanh_INFO  = 91
    SDO_ID_MIDLEVEL_ANKLE_REF_INFO      = 92
    SDO_ID_MIDLEVEL_ANKLE_REF_INFO2     = 93
    SDO_ID_MIDLEVEL_ASSIST_ONOFF        = 94
    SDO_ID_MIDLEVEL_RISK_PARAM          = 95
    SDO_ID_MIDLEVEL_INIT_TORQUE         = 96
    SDO_ID_MIDLEVEL_PHASE_SHIFT         = 97
    SDO_ID_MIDLEVEL_ANKLE_REF_INFO3     = 98
    SDO_ID_MIDLEVEL_IMPEDANCECTRL_INFO  = 99

    ##PDO ID LOWLEVEL
    PDO_ID_LOWLEVEL_CURRENT_OUTPUT   = 12  # 0x0C
    PDO_ID_LOWLEVEL_MID_ID_PROCESS_INPUT = 17  # 0x11

    ##PDO ID MIDLEVEL
    PDO_ID_MIDLEVEL_LOOP_CNT                   = 0
    PDO_ID_MIDLEVEL_REF_POSITION               = 1
    PDO_ID_MIDLEVEL_REF_VELOCITY               = 2
    PDO_ID_MIDLEVEL_ACTUAL_POSITION            = 3
    PDO_ID_MIDLEVEL_ACTUAL_VELOCITY_RAW        = 4
    PDO_ID_MIDLEVEL_SYSTEM_ID_SBS_FREQ         = 5
    PDO_ID_MIDLEVEL_IMP_CTRL_INPUT             = 6
    PDO_ID_MIDLEVEL_POS_PID_CTRL_INPUT         = 7
    PDO_ID_MIDLEVEL_VEL_PID_CTRL_INPUT         = 8
    PDO_ID_MIDLEVEL_VSD_INPUT                  = 9
    PDO_ID_MIDLEVEL_UNIT_TRAJECTORY_BUFF_COUNT = 10
    PDO_ID_MIDLEVEL_F_VECTOR_INPUT             = 11
    PDO_ID_MIDLEVEL_ABSENCODER1_POSITION       = 12
    PDO_ID_MIDLEVEL_ABSENCODER2_POSITION       = 13
    PDO_ID_MIDLEVEL_DOB_DISTURABNCE            = 14
    PDO_ID_MIDLEVEL_DOB_INPUT                  = 15
    PDO_ID_MIDLEVEL_FF_INPUT                   = 16
    PDO_ID_MIDLEVEL_VELOCITY_ESTIMATED         = 17
    PDO_ID_MIDLEVEL_IMP_EPSILON                = 18
    PDO_ID_MIDLEVEL_IMP_KP                     = 19
    PDO_ID_MIDLEVEL_IMP_KD                     = 20
    PDO_ID_MIDLEVEL_IMP_LAMDA                  = 21
    PDO_ID_MIDLEVEL_REF_POSITION1              = 22
    PDO_ID_MIDLEVEL_REF_POSITION2              = 23
    PDO_ID_MIDLEVEL_ABSENCODER1_VELOCITY       = 24
    PDO_ID_MIDLEVEL_ABSENCODER2_VELOCITY       = 25
    
    PDO_ID_MIDLEVEL_LS_CTRL_INPUT              = 26
    PDO_ID_MIDLEVEL_LOADCELL_FORCE             = 27
    PDO_ID_MIDLEVEL_REF_IMPEDANCE              = 28
    PDO_ID_MIDLEVEL_AC_CTRL_INPUT              = 29
    PDO_ID_MIDLEVEL_LOADCELL_TORQUE            = 30
    PDO_ID_MIDLEVEL_PMMG1                      = 31
    PDO_ID_MIDLEVEL_PMMG2                      = 32
    PDO_ID_MIDLEVEL_PMMG3                      = 33
    PDO_ID_MIDLEVEL_PMMG4                      = 34
    PDO_ID_MIDLEVEL_SBS_ID_DONE                = 35
    ############ Routine MSG      #########################
    ROUTINE_ID_MSG_PDO_SEND = 0
    ############ Routine LOWLEVEL #########################
    ROUTINE_ID_LOWLEVEL_CURRENT_CTRL              = 3
    ROUTINE_ID_LOWLEVEL_ADV_FRICTION_COMPENSATION = 6

    ############ Routine MIDLEVEL #########################
    ROUTINE_ID_MIDLEVEL_SYS_ID_SBS          = 0
    ROUTINE_ID_MIDLEVEL_POSITION_SINE_REF   = 4
    ROUTINE_ID_MIDLEVEL_POSITION_CTRL       = 5
    ROUTINE_ID_MIDLEVEL_VELOCITY_CTRL       = 6
    ROUTINE_ID_MIDLEVEL_DISTURBANCE_OBS     = 18
    ROUTINE_ID_MIDLEVEL_FEEDFORWARD_FILTER  = 21

    ROUTINE_ID_MIDLEVEL_LINEARIZE_STIFFNESS = 33
    ROUTINE_ID_MIDLEVEL_POSITION_TANH_REF   = 34
    ROUTINE_ID_MIDLEVEL_ANKLE_REF           = 35
    ROUTINE_ID_MIDLEVEL_RISK_MANAGEMENT     = 36
    ROUTINE_ID_MIDLEVEL_ANKLE_REF_PERIODIC  = 38
    ROUTINE_ID_MIDLEVEL_ANKLE_COMPENSATOR   = 39
    ...
    def send_msg(self, msg_raw):
        msg = self.flatten_list(msg_raw)
    ...
    def showData(self, data, id):
        if self.sysid_done ==0:
            if id==0x36C:
                ...
                print(f"cnt={data1}, ref={data2}, act={data3},phase={data10}")
                print("------------------------------------------------------")
